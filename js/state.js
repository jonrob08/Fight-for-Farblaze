...
class Standing extends State {
    ...
    update(player){
        ...
        if (this.direction == "left") {
            if (player.position.x < this.ai.position.x && player.position.x > this.ai.position.x - 400) {
...
class Running extends State {
    ...
    update(player){
        ...
        if (this.direction == "left" && this.ai.position.x <= player.position.x + 1000 ){
            this.ai.setState(states.ATTACKING_LEFT)
        
            
        } else if (this.direction == "right" && this.ai.position.x >= player.position.x - 1000 )
         {
